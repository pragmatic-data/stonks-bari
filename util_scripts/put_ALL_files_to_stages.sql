...
PUT 'file:///Users/robertozagni/RobMcZag/stonks-bari_IB_files/open_positions/*OpenPositions*.csv'
    ...
    OVERWRITE = FALSE
;
PUT 'file:///Users/robertozagni/RobMcZag/stonks-bari_IB_files/cash_transactions/*CashTransactions*.csv'
    @STONKS_BARI_DEV.LAND_IB.IB_CSV__STAGE/cash_transactions/
    AUTO_COMPRESS = TRUE
    OVERWRITE = FALSE
;
PUT 'file:///Users/robertozagni/RobMcZag/stonks-bari_IB_files/trades/*Trades*.csv'
    @STONKS_BARI_DEV.LAND_IB.IB_CSV__STAGE/trades/
    AUTO_COMPRESS = TRUE
    OVERWRITE = FALSE
;
PUT 'file:///Users/robertozagni/RobMcZag/stonks-bari_IB_files/transfers/Transfers*.csv'
